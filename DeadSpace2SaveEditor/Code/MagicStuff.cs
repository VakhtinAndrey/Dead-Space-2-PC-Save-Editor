...
namespace DeadSpace2SaveEditor.Code
{
    public static class MagicStuff
    {
        ...
        public static List<ItemDescriptor> ItemDescriptors = new List<ItemDescriptor>
        {
            ...
            new ItemDescriptor(new Guid(new byte[] { 0xF1, 0x63, 0xCB, 0x38, 0x24, 0xDE, 0xFD, 0xC8, 0x42, 0x45, 0x52, 0x54, 0x52, 0x41, 0x4D, 0x31 }), ItemType.Suit, "PDLC Weller Suit"),

            new ItemDescriptor(new Guid(new byte[] { 0xB5, 0x77, 0xCB, 0x38, 0xDE, 0x19, 0x65, 0xF7, 0x42, 0x45, 0x52, 0x54, 0x52, 0x41, 0x4D, 0x31 }), ItemType.Suit, "PDLC Miner Suit"),
            new ItemDescriptor(new Guid(new byte[] { 0xB6, 0x77, 0xCB, 0x38, 0x4A, 0x5E, 0x99, 0x03, 0x42, 0x45, 0x52, 0x54, 0x52, 0x41, 0x4D, 0x31 }), ItemType.Suit, "PDLC Security Suit"),
            new ItemDescriptor(new Guid(new byte[] { 0xB6, 0x77, 0xCB, 0x38, 0x2E, 0xDB, 0x79, 0x0D, 0x42, 0x45, 0x52, 0x54, 0x52, 0x41, 0x4D, 0x31 }), ItemType.Suit, "PDLC Advanced Suit"),
            new ItemDescriptor(new Guid(new byte[] { 0xB6, 0x77, 0xCB, 0x38, 0x7E, 0xA9, 0xDA, 0x15, 0x42, 0x45, 0x52, 0x54, 0x52, 0x41, 0x4D, 0x31 }), ItemType.Suit, "PDLC Heavy Damage"),
            new ItemDescriptor(new Guid(new byte[] { 0xB6, 0x77, 0xCB, 0x38, 0xF6, 0x17, 0x77, 0x38, 0x42, 0x45, 0x52, 0x54, 0x52, 0x41, 0x4D, 0x31 }), ItemType.Suit, "PDLC Quick Draw Suit"),
            new ItemDescriptor(new Guid(new byte[] { 0xB6, 0x77, 0xCB, 0x38, 0xB2, 0xC6, 0x21, 0x41, 0x42, 0x45, 0x52, 0x54, 0x52, 0x41, 0x4D, 0x31 }), ItemType.Suit, "PDLC EarthGov Suit"),
            new ItemDescriptor(new Guid(new byte[] { 0xB6, 0x77, 0xCB, 0x38, 0xA2, 0xAF, 0xC6, 0x4A, 0x42, 0x45, 0x52, 0x54, 0x52, 0x41, 0x4D, 0x31 }), ItemType.Suit, "PDLC Brushed Alum Suit"),
            new ItemDescriptor(new Guid(new byte[] { 0xB6, 0x77, 0xCB, 0x38, 0x68, 0xD4, 0x66, 0x54, 0x42, 0x45, 0x52, 0x54, 0x52, 0x41, 0x4D, 0x31 }), ItemType.Suit, "PDLC Bloody Suit"),
            //--------------------------------------------
            //                  Weapon
            //--------------------------------------------
...
new ItemDescriptor(new Guid(new byte[]{ 0x59, 0xEB, 0xC7, 0x38, 0x63, 0x65, 0xFE, 0x65, 0x4E, 0x4F, 0x4F, 0x4E, 0x41, 0x4E, 0x31, 0x30}), ItemType.Consumable, "Large Air Can"),
new ItemDescriptor(new Guid(new byte[]{ 0x07, 0xF0, 0xC7, 0x4B, 0xEE, 0xFA, 0x3F, 0x71, 0x43, 0x45, 0x4E, 0x54, 0x4B, 0x4F, 0x57, 0x53}), ItemType.Consumable, "Medium Air Can"),
new ItemDescriptor(new Guid(new byte[]{ 0x7F, 0xC9, 0xC7, 0x35, 0x50, 0xA3, 0xF3, 0xCC, 0x4D, 0x41, 0x54, 0x48, 0x55, 0x53, 0x37, 0x37}), ItemType.Consumable, "Small Air Can"),
            //--------------------------------------------
            //               Schematics
            //--------------------------------------------
